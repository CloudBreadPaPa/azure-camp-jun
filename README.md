# azure camp jun
이 repo는 2017년 6월 예정된 Azure dev camp 2일차 PaaS 과정에 대한 코드와 hands on 자료를 제공  
...
```
//최초 실행일 경우 email 및 nick을 입력할 수 있음.
git init  
git add .  
...
#### C# 코드
참고링크 : https://docs.microsoft.com/en-us/azure/cosmos-db/create-documentdb-dotnet  

#### node.js
참고링크 : https://docs.microsoft.com/en-us/azure/cosmos-db/create-documentdb-nodejs  
